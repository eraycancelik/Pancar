...
"background-color: rgb(25,25,25);")
        ...
        self.vehicle_info.setMinimumSize(QtCore.QSize(0, 0))
        self.vehicle_info.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
...
"background-color:rgb(210,210,210);")
        ...
        self.user_info.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"}")
    ...
    def retranslateUi(self, VehicleDynamicsApp):
        ...
        self.vehicle_info.setTitle(_translate("VehicleDynamicsApp", "Araç Bilgileri"))
        self.car_model_label.setText(_translate("VehicleDynamicsApp", "Marka-Model"))
        self.user_info.setTitle(_translate("VehicleDynamicsApp", "Kullanıcı Bilgileri"))
        self.user_info_label_area.setText(_translate("VehicleDynamicsApp", "   İsim Soyisim"))
        ...
        self.ets_list_label.setText(_translate("VehicleDynamicsApp", "Motor"))
        ...
        self.gearbox_list_label.setText(_translate("VehicleDynamicsApp", "Şanzıman"))
        ...
        self.vehicle_list_label.setText(_translate("VehicleDynamicsApp", "Araç"))
        ...
        self.env_list_label.setText(_translate("VehicleDynamicsApp", "Test Ortamı"))
        self.env_list_delete_button.setText(_translate("VehicleDynamicsApp", "-"))
        self.graph_area.setTitle(_translate("VehicleDynamicsApp", "Performans Grafikleri"))
        self.enginev_vehiclev.setText(_translate("VehicleDynamicsApp", "Motor Devri vs Araç Hızı"))
        self.torque_enginev.setText(_translate("VehicleDynamicsApp", "Tork vs Hız"))
        self.torque_enginev_power.setText(_translate("VehicleDynamicsApp", "Tork vs Hız vs Güç"))
        self.tractiveF_vehiclev.setText(_translate("VehicleDynamicsApp", "Çekiş Gücü (Bağımsız) vs Araç Hızı"))
        self.tractiveFnet_vehiclev.setText(_translate("VehicleDynamicsApp", "Ortamdaki Çekiş Gücü vs Araç Hızı"))
        ...
        self.actionProgram_Kaynaklar.setText(_translate("VehicleDynamicsApp", "Pancar"))
        ...
        self.actionDosyaya_Aktar.setText(_translate("VehicleDynamicsApp", "Rapor Oluştur"))
